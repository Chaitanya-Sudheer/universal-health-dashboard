...
const Sidemenu = () => {
  ...
  return (
    ...
    <div className='m-auto grid justify-center mt-4'>
        ...
        <li className='flex pt-3 pb-3 pl-3 gap-2 hover:opacity-100 items-center ' onClick={handleClick2} >
        <LuLayoutDashboard className='text-black'/>
        <span className='text-black'>Overview</span>
        </li>

        <li className='flex pt-3 pb-3 pl-3 gap-2 hover:opacity-100 items-center 'onClick={handleClick3}>
        <RxAvatar className='text-black'/>
        <span className='text-black'>Profile</span>
        </li>

        <li className='flex pt-3 pb-3 pl-3 gap-2 hover:opacity-100 items-center' onClick={handleClick5}>
        <GiOpenFolder className='text-black'/>
        <span className='text-black'>Records</span>
        </li>

        <li className='flex pt-3 pb-3 pl-3 gap-2 hover:opacity-100 items-center' onClick={handleClick4}>
        <FaFilePrescription className='text-black'/>
        <span className='text-black'>Prescription</span>
        </li>

        <li className='flex pt-3 pb-3 pl-3 gap-2 hover:opacity-100 items-center' onClick={handleClick6} >
        <RiMedicineBottleLine className='text-black'/>
        <span className='text-black'>Medicines</span>
        </li>

        <li className='flex pt-3 pb-3 pl-3 gap-2 hover:opacity-100 items-center' onClick={handleClick7}>
