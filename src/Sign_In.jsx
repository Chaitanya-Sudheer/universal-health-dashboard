...
const Sign_In = () => {
  ...
  return (
    <div>
      <Navigation />
      <div
        className="hero h-90 bg-blue-200"
        style={{
          backgroundImage:
      ...
      >
        <div className="hero-content flex-col lg:flex-row-reverse">
          <div className="card shrink-0 w-full mt-5 mb-5 max-w-sm shadow-2xl shadow-blue-200 bg-white-100 bg-opacity-10 backdrop-blur-lg bg-white-100 border border-blue-400 border-b-4 border-r-4 p-4">
              ...
              <div className="flex gap-4">
                <div className="form-control flex-1">
                  ...
                  <input
                    ...
                    className="input bg-white input-bordered input-info w-full text-black max-w-xs"
                    value={firstName}
