...
const Profile2 = () => {
  ...
  useEffect(() => {
    axiosInstance
      .post("doctors/profile", {}) // Empty body for the POST request
      .then((response) => {
            ...
            <div className="m-auto grid justify-center mt-4">
              <div className="max-h-screen overflow-y-auto">
                ...
                <ul>
                  ...
                  <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg text-white bg-blue-400 border-blue-400 hover:border-blue-500 hover:bg-blue-500 relative top-[-510px] ml-12">
                    Submit
                  </button>
                </ul>
              </div>
    ...
    <div className="flex flex-col md:flex-row min-h-screen w-full overflow-hidden">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="m-auto grid justify-left mt-4 relative">
          ...
          <div className="bg-white border border-blue-500 border-b-4 border-r-4 rounded-lg p-6 shadow-md ml-12 relative top-[150px] ">
            ...
            <p className="text-black mb-5 text-[18px]">
              Hospital Name: {profileData.hospital_name}
            </p>
            <p className="text-black mb-5 text-[18px]">
              Hospital Location: {profileData.hospital_location}
            </p>
            <p className="text-black mb-5 text-[18px]">
